...
func move_state(delta): # Codigo de movimientos del personaje
	...
	if Input.is_action_just_pressed("ui_ataque"):
		state = ATTACK
...
#Mask - Cosas que puedes tocar
#Mask: Con qué capas estoy dispuesto a interactuar.

#Layer - Cosas que pueden tocarte 
#Layer: A qué capa pertenezco.
